...
class PIDController:
    ...
    def compute(self, setpoint, pv, delta_time):
        error, pv_value = self.get_error_and_pv(setpoint, pv)
    ...
    def get_error_and_pv(self, setpoint, pv):
        error = setpoint - pv  
        return error, pv

class YolopInferenceNode(Node):
    def __init__(self, categories):
        super().__init__('yolop_inference')
        ...
        self.controller = PIDController(kp=2.75, ki=0, kd=0.08)
    ...
    def image_callback(self, msg):
        try:
            ...
            if deviation is None:
                ...
                control_action_msg.data = float(control_action)
